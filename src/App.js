        ...
        <div className='h-full w-full sm:w-3/12 sm:fixed bg-slate-50 sm:block hidden left-0 top-0'>
          <div className='w-9/12 h-full flex flex-col justify-around items-center'>
            ...
            <div className='flex flex-row gap-3 justify-between '>
              ...
              <div className='mt-6 flex flex-col gap-2'>
                <label className='flex flex-row gap-2'>
                  <input type='radio' name='price' value='0-50' onClick={handleClick} />
                  <span>0$-100$</span>
                </label>
                
                <label className='flex flex-row gap-2'>
                  <input type='radio' name='price' value='100-150' onClick={handleClick} />
                  <span>300$-400$</span>
                </label>
                <label className='flex flex-row gap-2'>
                  <input type='radio' name='price' value='150-200' onClick={handleClick} />
                  <span>400$-500$</span>
                </label>
              </div>
            </div>
